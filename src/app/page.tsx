          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <div className="mb-5">
                    <Link href="/home"> {/* temporary route to home page */}
                <a className="flex justify-center items-center w-full max-w-md mx-auto cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90">
                 Sign In
                </a>
                    </Link>
                </div>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link href="/face" className="text-primary">
                      Face Recog Test
                    </Link>
                  </p>
                </div>
